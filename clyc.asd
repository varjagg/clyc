  ...
  :components ((:file "subl-support")
               (:module "larkc-cycl"
                        ...
                        :components (;; MISSING-LARKC (:file "cyc-cvs-id")
                                     (:file "meta-macros")
                                     (:file "access-macros"
                                            :depends-on ("meta-macros"))
                                     (:file "subl-macro-promotions"
                                            :depends-on ("meta-macros" "access-macros"))
                                     ...
                                     (:file "sbhl/sbhl-link-iterators") ;; structs + resourcing vars only; all iterator logic is missing-larkc
                                     (:file "at-vars")
                                     (:file "gt-vars")
                                     (:file "czer-vars")
