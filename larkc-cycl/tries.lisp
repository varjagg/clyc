...
(defun* initialize-trie-ancestor-tracking (top-node) (:ignore t))
(defun* finish-trie-ancestor-tracking () (:ignore t))
(defun* trie-ancestor-tracking-descend (node) (:ignore t))
(defun* trie-ancestor-tracking-ascend () (:ignore t))
(defun* trie-relevant-ancestor-path? (trie) (:ignore t) t)
(defun* trie-relevant-object (trie object) (:ignore t) t)
(defun* multi-trie-new-insert-mark (trie object) (:ignore t))
(defun* multi-trie-remove-mark (trie object) (:ignore t))
