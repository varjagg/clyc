...
(setf *REALLY-COUNT-TRANSCRIPT-OPS* NIL)
...
;;; operations.
(setf *DONT-RECORD-OPERATIONS-LOCALLY* NIL)
...
(setf *STARTUP-COMMUNICATION-MODE* :DEAF)
...
(setf *MASTER-TRANSCRIPT-LOCK-HOST* "TRANSCRIPT-SERVER.CYC.COM")
...
(setf *CONSTANT-NAME-GREP-ENABLED* T)
...
(setf *CYC-GREP-CGI-PROGRAM* "constant-name-grep")
...
;;; and infrastructure.
(setf *CYC-EXECUTION-CONTEXT* :CYCORP)
...
(setf *TM-DISABLE-EDITING-GLOBALLY* NIL)
...
(setf *USE-HTTP-AUTHENTICATION* NIL)
...
(setf *SUPPORT-STRING* "your thesaurus administrator")
...
(setf *TM-CONTACTS* "your thesaurus administrator")

;;; Possible values: A string, giving the name of the application.
(setf *APPLICATION-NAME* "Cycorp Thesaurus")
...
;;; appear.
(setf *CLIENT-SPECIAL-LOGIN-INSTRUCTIONS* "Please enter your Thesaurus Cyclist ID in the box below, and hit ENTER or click the
LOGIN button.")
...
(setf *TM-EVENT-LOG-SAVE-QUANTUM* 300)
...
;;; that is enabled.
(setf *TM-LOAD-TRANSCRIPT-AT-STARTUP* NIL)
...
;;; loaded at startup.
(setf *TM-LOAD-THESAURUS-INIT-FILE-AT-STARTUP* NIL)
...
(setf *TM-SPECIAL-PREFERENCES-DIRECTORY* NIL)
...
;;; directory.
(setf *TM-SPECIAL-LOAD-THESAURUS-DIRECTORY* NIL)
...
;;; thesauri.
(setf *TM-SPECIAL-OUTPUT-DIRECTORY* NIL)
...
;;; do so themselves.
(setf *TM-DEFAULT-THESAURUS-NAME* NIL)
...
(setf *TM-NUMBER-OF-INCREMENTAL-SAVES-TO-KEEP* 2)
